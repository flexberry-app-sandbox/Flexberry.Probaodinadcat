...
namespace IIS.Probaodinadcat
{
    ...
    public class Карта : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probaodinadcat.ВидКарты fТипКарты;
        ...
        public virtual IIS.Probaodinadcat.ВидКарты ТипКарты
        {
            get
            {
                ...
                IIS.Probaodinadcat.ВидКарты result = this.fТипКарты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаE", typeof(IIS.Probaodinadcat.Карта));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаL", typeof(IIS.Probaodinadcat.Карта));
                }
            }
        }
    }
