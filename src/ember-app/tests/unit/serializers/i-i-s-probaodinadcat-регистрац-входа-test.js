...
moduleForModel('i-i-s-probaodinadcat-регистрац-входа', 'Unit | Serializer | i-i-s-probaodinadcat-регистрац-входа', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-probaodinadcat-регистрац-входа',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
