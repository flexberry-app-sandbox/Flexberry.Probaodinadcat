...
moduleForModel('i-i-s-probaodinadcat-вход-сотрудника', 'Unit | Serializer | i-i-s-probaodinadcat-вход-сотрудника', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-probaodinadcat-вход-сотрудника',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
